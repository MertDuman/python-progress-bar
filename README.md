# python-progress-bar
A progress bar that updates itselfs to display information.<br>
Inspired by Tensorflow's way of displaying network performance during training/testing.
...
def print_progress(cur, tot, fill="=", close=["[", "]"], length=20, opt=None, sep=" - ", add_newline=False):
    ...
    print(f"{cur:>{char_size}}/{tot} {close[0]}{fill * perc:{length}}{close[1]}{opt}", end='\r', flush=True)
